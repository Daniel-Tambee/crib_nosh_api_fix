...
# **getActivities**
> InlineResponse20055 getActivities(fields, limit, meta, offset, sort, filter, search)
...
# **getActivity**
> InlineResponse20056 getActivity(id, fields, meta)
...
try {
    var result = api_instance.getActivity(id, fields, meta);
    print(result);
} catch (e) {
