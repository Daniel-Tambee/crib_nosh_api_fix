...
class AuthenticationApi {
  ...
  Future<InlineResponse2002> oauth() async {
    ...
    // create path and map variables
    String path = "/auth/oauth".replaceAll("{format}","json");
  ...
  Future<InlineResponse2003> oauthProvider(String provider, { String redirect }) async {
    ...
    // create path and map variables
    String path = "/auth/oauth/{provider}".replaceAll("{format}","json").replaceAll("{" + "provider" + "}", provider.toString());
    ...
    Map<String, String> formParams = {};
    if(redirect != null) {
      queryParams.addAll(_convertParametersForCollectionFormat("", "redirect", redirect));
    }
  ...
  Future passwordRequest({ PasswordRequestBody body }) async {
    ...
    // create path and map variables
    String path = "/auth/password/request".replaceAll("{format}","json");
  ...
  Future passwordReset({ PasswordResetBody body }) async {
    ...
    // create path and map variables
    String path = "/auth/password/reset".replaceAll("{format}","json");
  ...
  Future<InlineResponse2001> refresh({ AuthRefreshBody body }) async {
    ...
    // create path and map variables
    String path = "/auth/refresh".replaceAll("{format}","json");
