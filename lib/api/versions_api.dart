...
class VersionsApi {
  ...
  Future<InlineResponse2005> compareContentVersion(String id) async {
    ...
    String path = "/versions/{id}/compare".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<InlineResponse20076> createContentVersion({ VersionsBody body, List<String> fields, String meta }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'InlineResponse20076') as InlineResponse20076 ;
    } else {
      return null;
    }
  }
  ...
  Future deleteContentVersion(String id) async {
    ...
    // create path and map variables
    String path = "/versions/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<InlineResponse20075> getContentVersions({ List<String> fields, int limit, int offset, String meta, List<String> sort, Object filter, String search }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'InlineResponse20075') as InlineResponse20075 ;
    } else {
      return null;
    }
  }
  ...
  Future<Object> promoteContentVersion(String id, { IdPromoteBody body }) async {
    ...
    // create path and map variables
    String path = "/versions/{id}/promote".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<Object> saveContentVersion(String id, { Object body }) async {
    ...
    // create path and map variables
    String path = "/versions/{id}/save".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
