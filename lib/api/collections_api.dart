...
class CollectionsApi {
  ...
  Future<InlineResponse20048> createCollection({ CollectionsBody body, String meta }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'InlineResponse20048') as InlineResponse20048 ;
    } else {
      return null;
    }
  }
  ...
  Future deleteCollection(String id) async {
    ...
    // create path and map variables
    String path = "/collections/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<InlineResponse20047> getCollections({ int offset, String meta }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'InlineResponse20047') as InlineResponse20047 ;
    } else {
      return null;
    }
  }
