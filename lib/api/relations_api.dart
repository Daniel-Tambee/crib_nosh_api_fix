...
class RelationsApi {
  ...
  Future<InlineResponse20060> createRelation({ RelationsBody body, List<String> fields, String meta }) async {
    ...
    String path = "/relations".replaceAll("{format}","json");
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'InlineResponse20060') as InlineResponse20060 ;
    } else {
      return null;
    }
  }
  ...
  Future deleteRelation(int id) async {
    ...
    // create path and map variables
    String path = "/relations/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<InlineResponse20059> getRelations({ List<String> fields, int limit, int offset, String meta, List<String> sort, Object filter, String search, int page }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'InlineResponse20059') as InlineResponse20059 ;
    } else {
      return null;
    }
  }
