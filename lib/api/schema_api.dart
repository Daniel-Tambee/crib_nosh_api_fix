...
class SchemaApi {
  ...
  Future schemaApply(SchemaApplyBody body) async {
    ...
    String path = "/schema/apply".replaceAll("{format}","json");
  ...
  Future<SchemaApplyBody> schemaDiff(SchemaDiffBody body, { bool force }) async {
    Object postBody = body;
    ...
    // create path and map variables
    String path = "/schema/diff".replaceAll("{format}","json");
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'SchemaApplyBody') as SchemaApplyBody ;
    } else {
      return null;
    }
  }
  ...
  Future<InlineResponse2004> schemaSnapshot({ String export_ }) async {
    ...
    // create path and map variables
    String path = "/schema/snapshot".replaceAll("{format}","json");
    ...
    Map<String, String> formParams = {};
    if(export_ != null) {
      queryParams.addAll(_convertParametersForCollectionFormat("", "export", export_));
    }
